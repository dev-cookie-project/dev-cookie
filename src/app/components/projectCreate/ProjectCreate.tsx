    ...
    <>
      <form>
        <div className="h-48 w-128 flex flex-col items-center justify-center bg-orange-300">
          <div className="h-36 w-129 bg-emerald-50 border-amber-800 rounded-xl p-4 text-black text-3xl flex flex-col items-center justify-center gap-4">
            <input placeholder="타이틀을 입력해주세요" />
          </div>
        </div>
        <div className="h-200 w-128 px-4 bg-orange-400 flex flex-col justify-center items-center">
          <div className="h-500 w-129 bg-emerald-50 border-amber-800 rounded-xl p-4 text-black text-3xl flex flex-col items-center justify-center gap-4">
            <textarea
              placeholder="프로젝트 내용을 입력해주세요"
              className="h-600 w-129"
            />
          </div>
          <div className="w-129 flex flex-row justify-end items-end m-4">
            <button
              type="submit"
